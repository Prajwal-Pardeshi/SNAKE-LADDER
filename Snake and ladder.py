...
board = pygame.image.load("D:/vs code/GAMES/Snake and ladder/data/images/board.png")
board = pygame.transform.scale(board, (896, 675)).convert_alpha()

# LOGO :
logo = pygame.image.load("D:/vs code/GAMES/Snake and ladder/data/images/logo.png").convert_alpha()

# DICE IMAGES :
dice_images = []
for i in range(1, 7):
    dice_i = pygame.image.load("D:/vs code/GAMES/Snake and ladder/data/images/dice/" + str(i) + ".jpg")
    dice_i = pygame.transform.scale(dice_i, (90, 83)).convert_alpha()
    dice_images.append(dice_i)

roll_dice = []
for i in range(1, 7):
    roll_i = pygame.image.load("D:/vs code/GAMES/Snake and ladder/data/images/dice/roll/" + str(i) + ".png")
    if i % 2 != 0:
...
def game_over(won):
    ...
    pygame.mixer.music.load("D:/vs code/GAMES/Snake and ladder/data/audios/DJ Snake - Magenta Riddim.mp3")
    pygame.mixer.music.play()

    pedestal_1 = pygame.image.load("D:/vs code/GAMES/Snake and ladder/data/images/display/pedestal1.png").convert_alpha()
    pedestal_2 = pygame.image.load("D:/vs code/GAMES/Snake and ladder/data/images/display/pedestal2.png").convert_alpha()

    winners = []
    for index in won:
        winner_index = pygame.image.load("D:/vs code/GAMES/Snake and ladder/data/images/pieces/" + str(index + 1) + ".png").convert_alpha()
...
def game_loop(num_players):
    ...
    pygame.mixer.music.stop()
    playlist = ["D:/vs code/GAMES/Snake and ladder/data/audios/Ed Sheeran - Shape Of You [Official].mp3",
                "D:/vs code/GAMES/Snake and ladder/data/audios/DJ Snake, Selena Gomez, Cardi B, Ozuna - Taki Taki.mp3",
                "D:/vs code/GAMES/Snake and ladder/data/audios/Sia - Cheap Thrills Ft. Sean Paul.mp3",
                "D:/vs code/GAMES/Snake and ladder/data/audios/Happy - Pharrell Williams (Original +) HD.mp3",
                "D:/vs code/GAMES/Snake and ladder/data/audios/Luis Fonsi - Despacito ft. Daddy Yankee.mp3"]
    ...
    for j in range(num_players):
        piece = pygame.image.load("D:/vs code/GAMES/Snake and ladder/data/images/pieces/" + str(j + 1) + ".png")
...
def num_of_players(vs_comp):
    vs_2 = pygame.image.load("D:/vs code/GAMES/Snake and ladder/data/images/display/vs2.png").convert_alpha()
    vs_3 = pygame.image.load("D:/vs code/GAMES/Snake and ladder/data/images/display/vs3.png").convert_alpha()
    vs_4 = pygame.image.load("D:/vs code/GAMES/Snake and ladder/data/images/display/vs4.png").convert_alpha()
...
# CHOOSE VERSUS :
def choose_versus():
    vs_computer = pygame.image.load("D:/vs code/GAMES/Snake and ladder/data/images/display/vscomputer.png").convert_alpha()
    vs_friends = pygame.image.load("D:/vs code/GAMES/Snake and ladder/data/images/display/vsfriends.png").convert_alpha()
...
def home_screen():
    ...
    background_music = pygame.mixer.music.load("D:/vs code/GAMES/Snake and ladder/data/audios/DJ Snake - Magenta Riddim.mp3")
    pygame.mixer.music.play()

    home_screen_1 = pygame.image.load("D:/vs code/GAMES/Snake and ladder/data/images/display/homescreen1.png").convert_alpha()
    home_screen_2 = pygame.image.load("D:/vs code/GAMES/Snake and ladder/data/images/display/homescreen2.png").convert_alpha()
